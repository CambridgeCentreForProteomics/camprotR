test_that("zero colours produces an error", {
  expect_error(get_cat_palette(0))
})

test_that("13 colours produces an error", {
  expect_error(get_cat_palette(13))
})

test_that("1 colour works", {
  expect_equal(get_cat_palette(1), "#2271B2")
})

test_that("7 colours work", {

...
print(p)
```
We can also look into this relationship at the tag level using `plot_missing_SN_per_sample`. In this case, there is no particular tag which appears to have a high proportion of missing values when signal:noise > 10.
```{r}
